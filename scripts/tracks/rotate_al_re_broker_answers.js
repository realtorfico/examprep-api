...
// Every question in al_re_broker_questions/*.json is drafted with the correct answer as choice_a
...
//
// Usage: node scripts/tracks/rotate_al_re_broker_answers.js

const fs = require('fs');
const path = require('path');

const dir = path.join(__dirname, 'al_re_broker_questions');
