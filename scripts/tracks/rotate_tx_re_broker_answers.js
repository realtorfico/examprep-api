...
// Every question in tx_re_broker_questions/*.json is drafted with the correct answer as choice_a
...
//
// Usage: node scripts/tracks/rotate_tx_re_broker_answers.js

const fs = require('fs');
const path = require('path');

const dir = path.join(__dirname, 'tx_re_broker_questions');
